...
headerImage: 'generada_hormigon.png'
features:
...
gallery:
  - 'generada_hormigon.png'
  - 'generada_hormigon_antes.png'
  - 'generada_hormigon_despues.png'
  - 'generada_hormigon_detalle.png'

parallaxImage: 'generada_hormigon.png'
